...
namespace Events.Tests.Services
{
    public class EventServiceTests
    {
        ...
        public async Task CreateEventAsync_WithEmptyOrNullTitle_ShouldThrowsValidationException(string? title)
        {
            ...
            exceptionAssertion.Which.ValidationErrors.Should().ContainKey("title");
        ...
        public async Task CreateEventAsync_WithEndAtBeforeStartAt_ShouldThrowsValidationException()
        {
            ...
            exceptionAssertion.Which.ErrorCode.Should().Be("Domain.ValidationFailed");
            exceptionAssertion.Which.ValidationErrors.Should().ContainKey("endAt");
        ...
        public async Task CreateEventAsync_WithEndAtEqualToStartAt_ShouldThrowsValidationException()
        {
            ...
            exceptionAssertion.Which.ErrorCode.Should().Be("Domain.ValidationFailed");
            exceptionAssertion.Which.ValidationErrors.Should().ContainKey("startAt").And.ContainKey("endAt");
        ...
        public async Task CreateEventAsync_WithPastStartAt_ShouldThrowsValidationException()
        {
            ...
            exceptionAssertion.Which.ErrorCode.Should().Be("Domain.ValidationFailed");
            exceptionAssertion.Which.ValidationErrors.Should().ContainKey("startAt");
        ...
        public async Task DeleteEventAsync_WithInvalidId_ShouldThrowNotFoundException()
        {
            ...
            var exceptionAssertion = await act.Should().ThrowAsync<EventNotFoundException>();

            exceptionAssertion.Which.ErrorCode.Should().Be("Event.NotFound");
            exceptionAssertion.Which.ErrorData.Should().BeEquivalentTo(new { parameter = "Id", value = invalidId.ToString() });
        ...
        public async Task GetEventByIdAsync_NonExisting_ShouldThrowNotFoundException()
        {
            ...
            exceptionAssertion.Which.ErrorCode.Should().Be("Event.NotFound");
            exceptionAssertion.Which.ErrorData.Should().BeEquivalentTo(new { parameter = "Id", value = expectedId.ToString() });
