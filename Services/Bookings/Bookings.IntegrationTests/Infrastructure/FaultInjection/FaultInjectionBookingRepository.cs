...
namespace Bookings.IntegrationTests.Infrastructure.FaultInjection;

sealed class FaultInjectingBookingRepository(IBookingRepository inner, FaultInjectionState state, BookingsDbContext dbContext) : IBookingRepository
{
