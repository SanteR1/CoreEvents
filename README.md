...
**Базовый URL API**: https://localhost:{порт}/events
...
| :--- | :--- | :--- |
| **Title** | `[Required]`, `AllowEmptyStrings = false` | Название не может быть пустым или состоять из пробелов. |
| **Description** | `nullable` (опционально) | Дополнительное описание события. |
| **StartAt** | `[Required]` | Дата начала обязательна для заполнения. |
| **EndAt** | `[Required]` | Дата окончания обязательна для заполнения. |
